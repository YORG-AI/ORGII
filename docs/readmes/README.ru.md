<div align="center">
  <h1>ORG-2</h1>
  <p><strong>Система записи для программного обеспечения, созданного с Agents.<br />Запускайте свои Agents для кода — воспроизводите любую сессию, проводите ревью командой и отслеживайте каждую строку до решения, которое её породило.</strong></p>
