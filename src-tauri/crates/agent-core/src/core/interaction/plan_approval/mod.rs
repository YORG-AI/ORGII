...
impl PlanApprovalManager {
    ...
    pub async fn mark_ready(
        ...
        // Persist while holding the pending mutex. Save/Build/Skip all acquire
        // the same mutex, so an older asynchronous mark_ready write cannot land
        // after a newer Save and roll the durable content backward.
