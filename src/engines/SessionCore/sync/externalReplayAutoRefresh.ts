...
export interface ExternalReplayRefreshSchedulerEnvironment {
  isHidden(): boolean;
  isFocused(): boolean;
...
export interface ExternalReplayRefreshScheduler {
  trigger(): void;
  reschedule(): void;
  stop(): void;
}

const browserRefreshSchedulerEnvironment: ExternalReplayRefreshSchedulerEnvironment =
  {
 ...
 */
export function startExternalReplayRefreshScheduler(options: {
  poll: () => Promise<void>;
  foregroundIntervalMs: number | (() => number);
  onHidden?: () => void;
  environment?: ExternalReplayRefreshSchedulerEnvironment;
...
export function useExternalReplayAutoRefresh(options: {
