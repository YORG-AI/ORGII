 ...
 *
 * The main thread hydrates this from `init_tool_registry`; projection workers
 * receive the same snapshot with their initial session message. Keeping this
 * module free of Tauri, React, and DOM imports makes it safe in both runtimes.
 */
