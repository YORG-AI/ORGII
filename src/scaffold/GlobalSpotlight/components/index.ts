...
export type { SpotlightAccountFooterProps } from "./SpotlightAccountFooter";
...
export type { ManageKeysFooterActionProps } from "./ManageKeysFooterAction";
