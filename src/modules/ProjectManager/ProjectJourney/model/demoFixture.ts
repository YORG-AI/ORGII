...
// Canonical aggregate fixtures own Project -> Session membership in demo mode,
// just as the aggregate does in production. Work-item links below only add
// metadata to these already-canonical sessions.
