...
| --- | ------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| 1   | No metadata content | Render without path or properties.               | No empty metadata band renders; the independent Discussion entry remains available after content. |
...
- [ ] Discussion appears after the primary Work Item content; it never shares the property metadata container.
