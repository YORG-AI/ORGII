/**
 * Browser Hooks - Barrel Export
 *
 * Hooks for browser/webview functionality: console, network logs,
...
export { useWebviewInspector } from "./useWebviewInspector";
export { useWebviewStyleEditor } from "./useWebviewStyleEditor";
