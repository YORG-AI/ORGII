...
| Typographic hierarchy                                | Every setup page uses the shared `text-xl` step heading, `text-sm` supporting copy, and existing ActionCard/SectionRow title scales; the page title does not overpower navigation or controls.                                                      |
