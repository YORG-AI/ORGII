 ...
 *
 * The sidebar header's icon control: a 28px round button on the sidebar's
 * own hover token. Counterpart of `TabBarTrailingIconButton`, which is the
...
export const SIDEBAR_CHROME_ICON_BUTTON_CLASS =
  "flex h-[28px] w-[28px] items-center justify-center rounded-[100px] border-none bg-transparent p-0 text-text-2 transition-colors duration-150";
